...
Z_VALUES = np.array(
    [
        [1.607, 1.514, 1.423, 1.379, 1.335, 1.291, 1.255, 1.213, 1.181, 1.154, 1.108, 1.078, 1.047, 1.032, 1.023],
        [1.712, 1.597, 1.486, 1.431, 1.378, 1.325, 1.278, 1.240, 1.207, 1.178, 1.139, 1.106, 1.072, 1.053, 1.038],
        [1.820, 1.682, 1.549, 1.484, 1.421, 1.359, 1.300, 1.266, 1.233, 1.202, 1.170, 1.133, 1.098, 1.073, 1.052],
        [1.905, 1.753, 1.607, 1.536, 1.466, 1.404, 1.351, 1.305, 1.268, 1.235, 1.196, 1.159, 1.121, 1.091, 1.065],
        [1.933, 1.782, 1.636, 1.565, 1.496, 1.434, 1.381, 1.333, 1.293, 1.257, 1.217, 1.177, 1.140, 1.107, 1.077],
        [1.904, 1.766, 1.633, 1.569, 1.505, 1.446, 1.392, 1.348, 1.308, 1.271, 1.235, 1.193, 1.154, 1.119, 1.088],
        [1.957, 1.799, 1.648, 1.575, 1.503, 1.452, 1.404, 1.363, 1.324, 1.285, 1.246, 1.207, 1.169, 1.133, 1.099],
        [1.925, 1.777, 1.634, 1.565, 1.497, 1.453, 1.413, 1.378, 1.345, 1.301, 1.259, 1.221, 1.188, 1.145, 1.109],
        [1.901, 1.758, 1.620, 1.553, 1.487, 1.448, 1.417, 1.388, 1.356, 1.314, 1.270, 1.227, 1.188, 1.150, 1.116],
        [1.850, 1.720, 1.594, 1.533, 1.473, 1.438, 1.417, 1.392, 1.375, 1.322, 1.274, 1.230, 1.190, 1.154, 1.122],
        [1.775, 1.665, 1.559, 1.507, 1.455, 1.423, 1.413, 1.390, 1.356, 1.310, 1.268, 1.228, 1.191, 1.158, 1.128],
        [1.680, 1.596, 1.514, 1.474, 1.434, 1.402, 1.405, 1.381, 1.338, 1.298, 1.260, 1.225, 1.192, 1.162, 1.134],
        [1.585, 1.526, 1.467, 1.438, 1.409, 1.379, 1.394, 1.368, 1.316, 1.283, 1.248, 1.220, 1.191, 1.164, 1.139],
    ],
    dtype="float64",
)
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Plot the provided reference table as a 3D surface.",
    )
    parser.add_argument(
        "--output",
        type=Path,
        default=Path("data/processed/plots/reference_table/reference_table_3d.png"),
    ...
    parser.add_argument(
        "--overlay-table",
        type=Path,
        default=Path("data/processed/tables/corner_maps/corner_scz_r_map_two_way_table_exact.csv"),
    ...
    parser.add_argument(
        "--html",
        nargs="?",
        const="data/processed/plots/reference_table/reference_table_3d.html",
        default=None,
...
def build_interactive_html(
    ...
    layout = {
        "title": "Reference Table 3D Surface",
        "scene": {
            "xaxis": {"title": "X"},
            "yaxis": {"title": "Y"},
            "zaxis": {"title": "Value"},
...
<head>
  ...
  <title>Reference Table 3D Surface</title>
...
def main() -> None:
    ...
    ax.set_title("Reference Table 3D Surface")
    ax.set_xlabel("X")
    ax.set_ylabel("Y")
    ax.set_zlabel("Value")
